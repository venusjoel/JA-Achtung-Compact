# JA Achtung Compact root testbench

This cocotb testbench exercises the standalone 1x1 Tiny Tapeout project,
`tt_um_ja_achtung_1x1`. Its Makefile lists the exact source set from
`targets/1x1-minimal`.
