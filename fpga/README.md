...
This project runs the exact JA Achtung Compact `1x1` Tiny Tapeout RTL on a
Terasic DE10-Lite (`10M50DAF484C7G`). The only FPGA-specific RTL is the thin
...
- One or two SNES-compatible controllers
...
the APS6404L reset/quad-enable sequence and clears the framebuffer before play.

Player 1 steers with L/R on controller 1 and player 2 with L/R on controller
2. Press Start after a crash to begin another round.
