...
Usage:
  python tests/view_map.py game_1x1            newest captured VGA map for that game
  python tests/view_map.py game_1x1
...
def main() -> int:
    ...
    captured_path = find_map(args[0] if args else "game_1x1")
